...
[Get Postman Collection](https://www.accounting.havenmw.com/public/index.php/docs/collection.json)
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "http://www.accounting.havenmw.com/public/index.php/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"sed","ip_address":"nulla","latitude":"quos","longitude":"et"}'
...
```bash
curl -X POST \
    "http://www.accounting.havenmw.com/public/index.php/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"corporis","latitude":"vitae","longitude":"et"}'
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/holidays?location_id=beatae&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=veritatis&follow_up_type=nostrum&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/crm/follow-ups"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"dolor","schedule_type":"est","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","followup_additional_info":"['call duration' => '1 hour']","allow_notification":true}'
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X PUT \
    "http://www.accounting.havenmw.com/public/index.php/connector/api/crm/follow-ups/20" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"ut","schedule_type":"aut","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","followup_additional_info":"['call duration' => '1 hour']","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","allow_notification":true}'
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=quos&biz_name=quisquam&mobile_num=12&contact_id=labore&order_by=veniam&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "http://www.accounting.havenmw.com/public/index.php/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"unde","mobile_name":"eius","call_type":"call","start_time":"enim","end_time":"mollitia","duration":"aspernatur"}]}'
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=dolores&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":6,"initial_amount":682571.85433467,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":71902891.56713,"total_card_slips":8,"total_cheques":2,"closing_note":"sequi","transaction_ids":"1,2,3"}'
...
let body = {
    "location_id": 6,
    "initial_amount": 682571.85433467,
    "created_at": "2020-5-7 15:20:22",
    "closed_at": "2020-5-7 15:20:22",
    "status": "close",
    "closing_amount": 71902891.56713,
    "total_card_slips": 8,
    "total_cheques": 2,
    "closing_note": "sequi",
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/contactapi?type=facere&name=quos&biz_name=ut&mobile_num=1&contact_id=quo&order_by=tenetur&direction=officia&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"impedit","prefix":"ea","first_name":"expedita","middle_name":"modi","last_name":"exercitationem","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"ipsa","address_line_2":"molestiae","city":"perferendis","state":"qui","country":"atque","zip_code":"quos","customer_group_id":"harum","contact_id":"error","dob":"2000-06-13","custom_field1":"nihil","custom_field2":"excepturi","custom_field3":"commodi","custom_field4":"ut","email":"excepturi","shipping_address":"molestiae","position":"quisquam","opening_balance":0,"source_id":15,"life_stage_id":7,"assigned_to":[]}'
...
let body = {
    "type": "customer",
    "supplier_business_name": "impedit",
    "prefix": "ea",
    "first_name": "expedita",
    "middle_name": "modi",
    ...
    "dob": "2000-06-13",
    "custom_field1": "nihil",
    "custom_field2": "excepturi",
    "custom_field3": "commodi",
    "custom_field4": "ut",
    "email": "excepturi",
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"odit","prefix":"quis","first_name":"quaerat","middle_name":"voluptas","last_name":"mollitia","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"et","address_line_2":"facere","city":"dolor","state":"possimus","country":"repudiandae","zip_code":"natus","customer_group_id":"dicta","contact_id":"assumenda","dob":"2000-06-13","custom_field1":"tempora","custom_field2":"sunt","custom_field3":"incidunt","custom_field4":"natus","email":"provident","shipping_address":"tenetur","position":"necessitatibus","opening_balance":10.3,"source_id":6,"life_stage_id":20,"assigned_to":[]}'
...
let body = {
    ...
    "address_line_1": "et",
    "address_line_2": "facere",
    "city": "dolor",
    "state": "possimus",
    "country": "repudiandae",
    "zip_code": "natus",
    "customer_group_id": "dicta",
    "contact_id": "assumenda",
    "dob": "2000-06-13",
    "custom_field1": "tempora",
    "custom_field2": "sunt",
    "custom_field3": "incidunt",
    "custom_field4": "natus",
    "email": "provident",
...
```bash
curl -X POST \
    "http://www.accounting.havenmw.com/public/index.php/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":9,"card_number":"ullam","card_holder_name":"fugit","card_transaction_number":"et","card_type":"nisi","card_month":"assumenda","card_year":"quo","card_security":"placeat","transaction_no_1":"eius","transaction_no_2":"vel","transaction_no_3":"asperiores","cheque_number":"illum","bank_account_number":"delectus","note":"sit"}'
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/expense?location_id=tempore&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=doloribus&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":17,"final_total":485.53,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":3,"expense_for":1,"contact_id":10,"additional_notes":"laudantium","is_refund":0,"is_recurring":0,"recur_interval":20,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"illum","recur_repetitions":7,"payment":[{"amount":453.13,"method":"cash","account_id":10,"card_number":"alias","card_holder_name":"velit","card_transaction_number":"et","card_type":"voluptates","card_month":"fuga","card_year":"eligendi","card_security":"voluptates","transaction_no_1":"consequatur","transaction_no_2":"pariatur","transaction_no_3":"ad","note":"atque","cheque_number":"quos"}]}'
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "http://www.accounting.havenmw.com/public/index.php/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":9.738,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":16,"expense_for":19,"contact_id":19,"additional_notes":"commodi","is_recurring":0,"recur_interval":13,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"blanditiis","recur_repetitions":11,"payment":[]}'
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/expense-refund?location_id=eligendi&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=vero&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/expense-refund"
);

let params = {
    "location_id": "eligendi",
    "payment_status": "paid",
    "start_date": "2018-06-25",
    "end_date": "2018-06-25",
    "expense_for": "vero",
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/product?order_by=illo&order_direction=et&brand_id=dolore&category_id=reiciendis&sub_category_id=voluptatem&location_id=voluptas&selling_price_group=amet&name=molestias&sku=voluptas&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/product"
);
...
let params = {
    ...
    "order_direction": "et",
    "brand_id": "dolore",
    "category_id": "reiciendis",
    "sub_category_id": "voluptatem",
    "location_id": "voluptas",
    "selling_price_group": "amet",
    "name": "molestias",
    "sku": "voluptas",
    "per_page": "10",
};
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/product/1?selling_price_group=distinctio" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/product/1"
);

let params = {
    "selling_price_group": "distinctio",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/variation/2?product_id=corrupti&location_id=voluptas&brand_id=dolores&category_id=sint&sub_category_id=voluptate&not_for_selling=tempora&name=nemo&sku=reprehenderit&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/variation/2"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/sell?location_id=aspernatur&contact_id=laborum&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=rerum&service_staff_id=molestiae&shipping_status=ordered&only_subscriptions=ipsa&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/sell"
);

let params = {
    "location_id": "aspernatur",
    "contact_id": "laborum",
    "payment_status": "paid",
    "start_date": "2018-06-25",
    "end_date": "2018-06-25",
    "user_id": "rerum",
    "service_staff_id": "molestiae",
    "shipping_status": "ordered",
    "only_subscriptions": "ipsa",
    "order_by_date": "desc",
    "per_page": "10",
};
Object.keys(params)
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":20,"contact_id":2,"transaction_date":"2020-07-22 15:48:29","invoice_no":"fugiat","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":12,"discount_amount":10,"discount_type":"fixed","sale_note":"dignissimos","staff_note":"repellat","commission_agent":17,"shipping_details":"Express Delivery","shipping_address":"reiciendis","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":13,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":9,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"fugiat","recur_repetitions":9,"rp_redeemed":9,"rp_redeemed_amount":13.5,"types_of_service_id":7,"service_custom_field_1":"in","service_custom_field_2":"iusto","service_custom_field_3":"sit","service_custom_field_4":"et","service_custom_field_5":"vel","service_custom_field_6":"distinctio","round_off_amount":8.22891288,"table_id":1,"service_staff_id":20,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":10,"note":"nulla"}],"payments":[{"amount":453.13,"method":"cash","account_id":19,"card_number":"in","card_holder_name":"quaerat","card_transaction_number":"esse","card_type":"a","card_month":"magnam","card_year":"similique","card_security":"itaque","transaction_no_1":"veritatis","transaction_no_2":"nisi","transaction_no_3":"ex","bank_account_number":"rerum","note":"mollitia","cheque_number":"incidunt"}]}]}'
    ...
    "sells": [
        {
            ...
            "recur_interval_type": "months",
            "subscription_repeat_on": 15,
            "subscription_no": "fugiat",
            "recur_repetitions": 9,
            "rp_redeemed": 9,
            "rp_redeemed_amount": 13.5,
            "types_of_service_id": 7,
            "service_custom_field_1": "in",
            "service_custom_field_2": "iusto",
            "service_custom_field_3": "sit",
            "service_custom_field_4": "et",
            "service_custom_field_5": "vel",
            "service_custom_field_6": "distinctio",
            "round_off_amount": 8.22891288,
            "table_id": 1,
            "service_staff_id": 20,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "account_id": 19,
                    "card_number": "in",
                    "card_holder_name": "quaerat",
                    "card_transaction_number": "esse",
                    "card_type": "a",
                    "card_month": "magnam",
                    "card_year": "similique",
                    "card_security": "itaque",
                    "transaction_no_1": "veritatis",
                    "transaction_no_2": "nisi",
                    "transaction_no_3": "ex",
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/sell/55" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/sell/55"
);
...
```bash
curl -X PUT \
    "http://www.accounting.havenmw.com/public/index.php/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":2,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":7,"discount_amount":10,"discount_type":"fixed","sale_note":"ut","staff_note":"quis","sells":[{"is_suspend":false}],"commission_agent":13,"shipping_details":"Express Delivery","shipping_address":"sequi","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":9,"pay_term_number":11,"pay_term_type":"months","is_recurring":0,"recur_interval":15,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"ea","recur_repetitions":1,"rp_redeemed":20,"rp_redeemed_amount":13.5,"types_of_service_id":1,"service_custom_field_1":"maiores","service_custom_field_2":"autem","service_custom_field_3":"delectus","service_custom_field_4":"est","service_custom_field_5":"harum","service_custom_field_6":"reprehenderit","round_off_amount":481898.2117,"table_id":15,"service_staff_id":10,"change_return":0,"change_return_id":20,"products":[{"sell_line_id":11,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":15,"discount_amount":0,"discount_type":"percentage","sub_unit_id":19,"note":"repellendus"}],"payments":[{"payment_id":6,"amount":453.13,"method":"cash","account_id":4,"card_number":"quis","card_holder_name":"est","card_transaction_number":"officiis","card_type":"repudiandae","card_month":"provident","card_year":"laboriosam","card_security":"tempora","transaction_no_1":"et","transaction_no_2":"aperiam","transaction_no_3":"tempora","note":"numquam","cheque_number":"ut","bank_account_number":"perferendis"}]}'
...
let body = {
    ...
    "rp_redeemed_amount": 13.5,
    "types_of_service_id": 1,
    "service_custom_field_1": "maiores",
    "service_custom_field_2": "autem",
    "service_custom_field_3": "delectus",
    "service_custom_field_4": "est",
    "service_custom_field_5": "harum",
    "service_custom_field_6": "reprehenderit",
    "round_off_amount": 481898.2117,
    "table_id": 15,
    "service_staff_id": 10,
    "change_return": 0,
    "change_return_id": 20,
    ...
    "payments": [
        {
            ...
            "card_transaction_number": "officiis",
            "card_type": "repudiandae",
            "card_month": "provident",
            "card_year": "laboriosam",
            "card_security": "tempora",
            "transaction_no_1": "et",
            "transaction_no_2": "aperiam",
            "transaction_no_3": "tempora",
            "note": "numquam",
            "cheque_number": "ut",
            "bank_account_number": "perferendis"
        }
    ]
}
...
```bash
curl -X DELETE \
    "http://www.accounting.havenmw.com/public/index.php/connector/api/sell/odio" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "http://www.accounting.havenmw.com/public/index.php/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":8,"transaction_date":"2020-5-7 15:20:22","invoice_no":"iste","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":15,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "http://www.accounting.havenmw.com/public/index.php/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":5,"shipping_status":"ordered","delivered_to":"maxime"}'
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/table?location_id=voluptate" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/table"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/taxonomy?type=omnis" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/user/loggedin"
);
...
```bash
curl -X POST \
    "http://www.accounting.havenmw.com/public/index.php/connector/api/user-registration" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"sed","first_name":"consequatur","last_name":"maiores","email":"rem","is_active":"optio","user_type":"error","crm_contact_id":4,"allow_login":true,"username":"quis","password":"qui","role":8,"access_all_locations":true,"location_permissions":[],"cmmsn_percent":"nemo","max_sales_discount_percent":"nulla","selected_contacts":true,"selected_contact_ids":[],"dob":"nam","gender":"molestiae","marital_status":"quibusdam","blood_group":"quisquam","contact_number":"consequatur","alt_number":"fugit","family_number":"magnam","fb_link":"ducimus","twitter_link":"veniam","social_media_1":"provident","social_media_2":"culpa","custom_field_1":"laudantium","custom_field_2":"facilis","custom_field_3":"a","custom_field_4":"cupiditate","guardian_name":"repudiandae","id_proof_name":"dolorem","id_proof_number":"dolores","permanent_address":"nam","current_address":"voluptates","bank_details":[{"account_holder_name":"earum","account_number":"debitis","bank_name":"recusandae","bank_code":"velit","branch":"explicabo","tax_payer_id":"consectetur"}]}'
...
let body = {
    ...
    "cmmsn_percent": "nemo",
    "max_sales_discount_percent": "nulla",
    "selected_contacts": true,
    "selected_contact_ids": [],
    "dob": "nam",
    "gender": "molestiae",
    "marital_status": "quibusdam",
    "blood_group": "quisquam",
    "contact_number": "consequatur",
    "alt_number": "fugit",
    "family_number": "magnam",
    "fb_link": "ducimus",
    "twitter_link": "veniam",
    "social_media_1": "provident",
    "social_media_2": "culpa",
    "custom_field_1": "laudantium",
    "custom_field_2": "facilis",
    "custom_field_3": "a",
    "custom_field_4": "cupiditate",
    "guardian_name": "repudiandae",
    "id_proof_name": "dolorem",
    "id_proof_number": "dolores",
    "permanent_address": "nam",
    "current_address": "voluptates",
    "bank_details": [
        {
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/user?service_staff=harum" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/user"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/user/1"
);
...
```bash
curl -X POST \
    "http://www.accounting.havenmw.com/public/index.php/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"repellendus","new_password":"omnis"}'
...
```bash
curl -X POST \
    "http://www.accounting.havenmw.com/public/index.php/connector/api/forget-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"email":"ut"}'
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/profit-loss-report?location_id=facilis&start_date=2018-06-25&end_date=2018-06-25&user_id=iste" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "http://www.accounting.havenmw.com/public/index.php/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://www.accounting.havenmw.com/public/index.php/connector/api/notifications"
);
