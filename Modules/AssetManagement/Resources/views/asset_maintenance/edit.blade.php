        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            {!! Form::label('details', __('assetmanagement::lang.details') . ':' )!!}
                            {!! Form::textarea('details', $maintenance->details, ['class' => 'form-control', 'placeholder' => __('assetmanagement::lang.details'), 'rows' => 3]); !!}
                        </div>
                    </div>
                </div>
            </div>
